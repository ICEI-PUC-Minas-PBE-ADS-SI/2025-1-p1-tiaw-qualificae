...
| Passos | - Acessar o navegador <br> - Informar o endereço do site ([LINK DO SITE](https://two025-1-p1-tiaw-qualificae.onrender.com/index.html)) <br> - Clicar no botão "Entrar" <br> - Preencher o campo de e-mail <br> - Preencher o campo de senha <br> - Clicar em "Login". |
...
| Passos | - Acessar o navegador. <br> - Informar o endereço do site ([LINK DO SITE](https://two025-1-p1-tiaw-qualificae.onrender.com/index.html)). <br> - No Menu Principal, clicar em “Cursos”. <br> - Navegar na pagina a procura do curso de seu interesse. <br> |
...
| Passos | - Acessar o navegador. <br> - Clicar em “- Informar o endereço do site ([LINK DO SITE](https://two025-1-p1-tiaw-qualificae.onrender.com/index.html))”. <br> - Clicar em “Currículos”. <br> - Preencher os campos  que o usuário queira colocar no currículo. <br> - Clicar em "Salvar". <br> |
...
| Passos | - Acessar o navegador. <br> -Informar o endereço do site ([LINK DO SITE](https://two025-1-p1-tiaw-qualificae.onrender.com/index.html)). <br> - Clicar em “Cursos”. <br> - Clicar na Bandeira relacionada aos favoritos. <br>|
...
| Passos | - Acessar o navegador. <br> - Informar o endereço do site ([LINK DO SITE](https://two025-1-p1-tiaw-qualificae.onrender.com/index.html)). <br> - Clicar em “Favoritos”. <br> - Clicar na Bandeira relacionada aos favoritos. <br> - abre a página com o nome do usuário|
...
| Passos | - Acessar o navegador. <br> - Informar o endereço do site ([LINK DO SITE](https://two025-1-p1-tiaw-qualificae.onrender.com/index.html)). <br> - Clicar em “Cursos”. <br> - Utilizar a Barra de Pesquisa. |
...
| Passos | - Acessar o navegador <br> - Informar o endereço do site ([LINK DO SITE](https://two025-1-p1-tiaw-qualificae.onrender.com/index.html)) <br> - Clicar em no ícone da avaliação <br> - Fornecer a nota desejada ao site <br> - Escrever um comentário desejado <br> - Clicar em “Enviar”|
...
| Passos | - Acessar o navegador. <br> - Informar o endereço do site ([LINK DO SITE](https://two025-1-p1-tiaw-qualificae.onrender.com/index.html)). <br> - Clicar em “Forum”. <br> - Adicionar um “LIKE”  ou “DESLIKE” em um comentário. |
...
| Passos | OBS: O usuário deverá estar logado. <br> - Acessar o navegador. <br> - Informar o endereço do site ([LINK DO SITE](https://two025-1-p1-tiaw-qualificae.onrender.com/index.html)). <br> - Clicar no ícone dos favoritos. <br> - Clicar no Ícone da lixeira para remover o curso dos favoritos.|
